  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      ...
      <div className='container z-10 flex flex-col w-full mx-auto items-center'>
        <h4 className='font-light text-white text-xl font-sans xl:text-3xl'>Seja bem-vindo ao</h4>
        <h1 className='my-5 text-blue-300 font-bold text-5xl xl:text-7xl font-sans'>NEXUS</h1>
